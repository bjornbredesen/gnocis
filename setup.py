...
setup(
	ext_modules = [ Extension(name = 'gnocis.' + x, sources = ['gnocis/'+ x + '.cpp']) for x in ['biomarkers', 'common', 'features', 'models', 'motifs', 'regions', 'sequences', 'validation', 'featurenetwork'] ],
	name = "gnocis",
	packages = [ "gnocis" ],
